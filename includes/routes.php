...
Router::page('teacher/grading/students', 'teacher/grading_students.php', ['teacher', 'lecturer']);
Router::page('teacher/grading/roster', 'teacher/roster.php', ['teacher', 'lecturer']);
...
Router::page('it_admin/resolve', 'it_admin/it_admin.php', 'it_admin');
    ...
    Router::page('it_admin/heartbeat', 'it_admin/it_admin.php', 'it_admin');
