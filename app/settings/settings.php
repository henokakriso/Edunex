        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($tab === 'display') {
                Database::update('users', [
                    ...
                    'card_radius' => $_POST['card_radius'] ?? '18',
                    'line_height' => $_POST['line_height'] ?? '1.55',
                    'toast_position' => $_POST['toast_position'] ?? 'top-right',
                    'table_density' => $_POST['table_density'] ?? 'normal',
