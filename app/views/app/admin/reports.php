...
?>
<style>
.rpt-type{display:flex;align-items:center;gap:12px;padding:12px 14px;border-radius:10px;border:2px solid var(--border);cursor:pointer;transition:all .15s;background:var(--bg-elev)}
.rpt-type:hover{border-color:color-mix(in srgb,var(--accent) 40%,var(--border))}
.rpt-type.selected{border-color:var(--accent);background:var(--accent-soft)}
