...
<div class="page-head" style="margin-bottom:18px">
  ...
  <button class="btn btn-primary" data-open-modal="new-holiday-modal">+ New Holiday</button>
</div>

<!-- Create Holiday Modal -->
<div class="modal-backdrop" id="new-holiday-modal">
    ...
    <div class="modal-body">
      <form method="post">
        ...
        <div style="margin-bottom:16px">
          <h4 style="margin:0 0 10px;font-size:14px;font-weight:700">Holiday Information</h4>
        ...
        <div style="margin-bottom:16px">
          <h4 style="margin:0 0 10px;font-size:14px;font-weight:700">Date</h4>
        ...
        <div style="margin-bottom:16px">
          <h4 style="margin:0 0 10px;font-size:14px;font-weight:700">Authority</h4>
          <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:12px">
        ...
        <div class="modal-foot">
          ...
          <button class="btn btn-primary" type="submit"><?= icon('plus') ?> Create Holiday</button>
        </div>
      </form>
    </div>
  </div>
