...
<div class="modal-dialog" id="new-school-modal">
  <form method="post" class="modal-box" style="max-height:92vh;overflow:auto;padding:22px">
    <?= csrf_field() ?>
    <h3 class="card-title"><?= icon('plus') ?> Request new university</h3>
    <div class="grid2" style="margin-top:6px">
      ...
      <input type="hidden" name="education_level" value="university">
    ...
    <div class="flex gap-10" style="margin-top:16px">
      <button class="btn btn-success" name="create_school" value="1"><?= icon('rocket') ?> Submit for approval</button>
