...
<div class="page-head">
  ...
  <div class="flex gap-8">
    ...
    <button class="btn btn-primary" data-open-modal="new-course-modal">+ New course</button>
  </div>
</div>

<div class="modal-backdrop" id="new-course-modal">
  <div class="modal" style="max-width:560px">
    <div class="modal-head">
      <h3><?= icon('plus') ?> New course</h3>
    ...
    <div class="modal-body">
      <form method="post">
        ...
        <div class="modal-foot">
          ...
          <button class="btn btn-primary" name="create_course" value="1"><?= icon('rocket') ?> Create course</button>
        </div>
      </form>
    </div>
  </div>
