...
<div class="page-head">
  ...
  <form method="get" class="inline">
    ...
    <div class="input-icon-wrap" style="width:250px">
      ...
      <input class="input has-ico" name="q" id="stu-search" value="<?= e($q) ?>" placeholder="Search name, ID, email…" oninput="document.getElementById('stu-clear').style.display=this.value?'flex':'none'">
