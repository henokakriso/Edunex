...
<div class="card">
  <div style="overflow-x:auto">
    <table class="table">
      <thead><tr><th>School</th><th>Directors</th><th>Students</th><th>Teachers</th><th>Status</th><th>Actions</th></tr></thead>
      <tbody>
      <?php if (empty($rows)): ?>
        <tr><td colspan="6" style="text-align:center;color:var(--muted)">No schools found.</td></tr>
      <?php else: foreach ($rows as $r): ?>
        <tr>
          <td><a href="<?= url('index.php?r=woreda/school&id='.$r['id']) ?>"><?= e($r['name']) ?></a></td>
          <td><?= e($r['directors']) ?></td>
          <td><?= e($r['students']) ?></td>
          <td><?= e($r['teachers']) ?></td>
