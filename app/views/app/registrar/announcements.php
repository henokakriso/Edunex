<?php /* Registrar announcements — post to your school */
?>
<div class="page-head">
  <div>
    <h1><?= icon('megaphone') ?> Announcements</h1>
    <p class="sub">Broadcast to your school</p>
  </div>
</div>
    ...
    <?php foreach ($rows as $a): ?>
      <div class="list-row" style="padding:9px 0">
        ...
        <div class="flex-1">
          ...
          <p class="tiny faint"><?= e(ucfirst($a['audience'])) ?> · <?= e(time_ago($a['created_at'])) ?></p>
