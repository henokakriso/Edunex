...
$__nav = [
  ...
  'vice_dean' => [
    ['dash', 'Dashboard', 'vice_dean/dashboard', icon('home')],
    ['FACULTY'],
    ['courses', 'Course Approval', 'vice_dean/courses', icon('exam')],
    ['analytics', 'Analytics', 'vice_dean/analytics', icon('chart-bar')],
  ],
  'dept_head' => [
    ['dash', 'Dashboard', 'dept_head/dashboard', icon('home')],
    ['DEPARTMENT'],
...
<head>
  ...
  <link rel="stylesheet" href="<?= url('public/css/app.css?v=24') ?>">
</head>
<body>
  <div class="shell">
    <!-- ======================= SIDEBAR ======================= -->
